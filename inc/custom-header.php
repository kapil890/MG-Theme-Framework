...
function twentyseventeen_custom_header_setup() {
	...
	register_default_headers( array(
		'default-image' => array(
			...
			'description'   => __( 'Default Header Image', 'themefw' ),
		),
	) );
}
...
function twentyseventeen_video_controls( $settings ) {
	$settings['l10n']['play'] = '<span class="screen-reader-text">' . __( 'Play background video', 'themefw' ) . '</span>' . twentyseventeen_get_svg( array( 'icon' => 'play' ) );
	$settings['l10n']['pause'] = '<span class="screen-reader-text">' . __( 'Pause background video', 'themefw' ) . '</span>' . twentyseventeen_get_svg( array( 'icon' => 'pause' ) );
	return $settings;
}
